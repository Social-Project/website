					...
					<section id="top" class="one dark cover">
						<div class="container">
							...
							<header>
								...
								<p>Le tout nouveau réseau social qui vous permettra de partager toute votre créativé à vos amis, votre famille, vos collègues... Vous pouvez aussi créer ou rejoindre des communautés pour vous permettre de parler avec des autres personnes ayant la même passion. Si vous souhaitez plus d\'infos, visitez notre Wiki !</p>
							</header>
